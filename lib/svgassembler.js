...
export class SVGDOMAssembler {
    ...
    set classList(list) {
        ...
        list.forEach(token => token && classList.add(token))
    }
    ...
    get x1() {
        return this.node.getAttribute('x1')
    }
    ...
    get x2() {
        return this.node.getAttribute('x2')
    }
    ...
    get y1() {
        return this.node.getAttribute('y1')
    }
    ...
    get y2() {
        return this.node.getAttribute('y2')
    }
    ...
    get z() {
        return this.node.getAttribute('z')
    }
